...
class DoubleCell {
    ...
    public DoubleCell(Game element) {
...
class Lista {
    ...
    public void sort() { 
        ...
        quicksort(0, size - 1); 
        /* 
        Arq.openWrite("746032_quicksort2.txt");
        Arq.println("746032\t" + (System.currentTimeMillis() - t_begin) + "ms\t" + c_compares);
        Arq.close(); */
    }
    ...
    private void quicksort(int low, int high) {
        ...
        Game pivot = array[low + (high - low) / 2].element;
        ...
        while(i <= j) {
            ...
            if(array[i].element.getReleaseDate().compareTo(pivot.getReleaseDate()) == 0) {
                ...
                while(array[i].element.getReleaseDate().compareTo(pivot.getReleaseDate()) < 0) {
            ...
            if(array[j].element.getReleaseDate().compareTo(pivot.getReleaseDate()) == 0) {
                ...
                while(array[j].element.getReleaseDate().compareTo(pivot.getReleaseDate()) > 0) {
