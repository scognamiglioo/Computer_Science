...
int main() {
    ...
    while(true) {
        ...
        if(found.app_id != -1) stack_insert(found);
    ...
    for(int i = 0; i < n_ops; i++) {
        ...
        if(line_in[0] == 'I') {
            ...
            if(line_in[1] == 'I') stack_insert(game_search(atoi(params)));
           
        }
        else if(line_in[0] == 'R') {

            
            printf("(R) %s\n", stack_remove(atoi(params)).name);
        }
    }
