...
class No {
    ...
    public No(Game element) { this(element, null, null); }

    public No(Game element, No left, No right) {
...
class ArvoreBinaria {
	...
	private boolean search(String x, No i) {
	...
	private No insert(Game x, No i) throws Exception {
    ...
    public Game remove(String x) throws Exception {
...
public class Principal{
    ...
    public static void main(String[] args) throws Exception{
        ...
        ArvoreBinaria item = new ArvoreBinaria();
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (r.equals("I")) {
                ...
                param = line.substring(2, line.length());
