...
class Hash {
	...
	public boolean inserir(Game element) {
	...
	public boolean pesquisar(String name) {
        ...
        if(table[pos] != null) {
            ...
            if(table[pos].getName().compareTo(name) == 0) {
                ...
                for(int i = 0; i < backup; i++) {
                    ...
                    if(table[m1 + i].getName().compareTo(name) == 0) {
