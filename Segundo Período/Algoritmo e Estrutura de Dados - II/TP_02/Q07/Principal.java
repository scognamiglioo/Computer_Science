...
class Fila {
    ...
    public void inserir(Game game) throws Exception {
        ...
        if(((ultimo + 1) % array.length) == primeiro) throw new Exception("Erro ao inserir!");
    ...
    public int length() { return ultimo - primeiro; }
}
    ...
    public static void main(String[] args) throws Exception{
        ...
        while(true) {
            ...
            for(Game game : games) {
                ...
                try { item.inserir(game); }
                catch(java.lang.Exception e) {
    
                    totalDuration -= item.remove().getAvgPlaytime();
                    c--;
                    
                    item.inserir(game);
                }
                totalDuration += game.getAvgPlaytime();

                System.out.println(Math.round(totalDuration / ++c));
            }
            }
        ...
        for(int i = 0; i < n; i++) {
            ...
            if(op.compareTo("I") == 0) {
                ...
                for(Game game : games) {
                    ...
                    System.out.println("I " + game.getAppId());
                ...
                Game resp = item.remove();

                totalDuration -= resp.getAvgPlaytime();
                c--;
