...
class Game {
    ...
    public ArrayList<String> getReleaseDates() { return this.genres; }
...
class Lista {
    ...
    public void inserirFim(Game movie) throws Exception {
    ...
    public void construir(int tamHeap) {
        for (int i = tamHeap; i > 1 && array[i].getReleaseDate().compareTo(array[i / 2].getReleaseDate()) > array[i / 2].getReleaseDate().compareTo(array[i].getReleaseDate()); i /= 2) {
            swap(i, i / 2);
        }
    }
    ...
    public void reconstruir(int tamHeap) {
        ...
        while (i <= (tamHeap / 2)) {
            ...
            if (array[i].getReleaseDate().compareTo(array[filho].getReleaseDate()) < array[filho].getReleaseDate().compareTo(array[i].getReleaseDate())) {
                swap(i, filho);
                i = filho;
                //count++;
            } else {
    ...
    public int getMaiorFilho(int i, int tamHeap) {
        int filho;
        if (2 * i == tamHeap || array[2 * i].getReleaseDate().compareTo(array[2 * i + 1].getReleaseDate()) > array[2 * i + 1].getReleaseDate().compareTo(array[2 * i].getReleaseDate())) {
            filho = 2 * i;
           // count++;
        } else {
            filho = 2 * i + 1;
