...
class Lista {
    ...
    public void inserirFim(Game games) throws Exception {
    ...
    private void quicksort(int esq, int dir) {
        ...
        while (i <= j) {
            while (array[i].getReleaseDate().compareTo(pivo.getReleaseDate()) < pivo.getReleaseDate().compareTo(array[i].getReleaseDate())) {
                i++;
            }
            while (array[j].getReleaseDate().compareTo(pivo.getReleaseDate()) > pivo.getReleaseDate().compareTo(array[j].getReleaseDate())) {
                j--;
            }
            if (i <= j) {
                swap(i, j);
